...
id="delete-subscription">
    @csrf
    @method('delete')
    <button type="submit" class="px-[19px] py-[13px] bg-[#FE4848] rounded-full text-center" id="delete-subscription-btn">
        <span class="text-white font-semibold text-base">
            Stop Subscribe
        </span>
    </button>
...
@section('js')
    <script>
        document.getElementById('delete-subscription-btn')
                .addEventListener('click', function(event){
                    event.preventDefault(); // berhentikan event di html
